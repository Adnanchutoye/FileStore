...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001930406310"))

# NAMA OWNER
OWNER = os.environ.get("OWNER", "Rin_Nanakura")
...
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1001930406310"))
...
try:
    ADMINS=[7432102513]
    for x in (os.environ.get("ADMINS", "7432102513 5585016974 7478045719 6564336670").split()):
        ADMINS.append(int(x))
except ValueError:
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @Anime_Sub_Society</b>")
